<x-main title="Pembayaran Manual">
            ...
            <div class="flex-wrap md:flex">
                <div class="mx-auto">
                    <img class="mx-auto mt-12 h-52 w-52 rounded-lg border p-2 md:mt-0"
                        src="https://i.imgur.com/FQS7fFC.png" alt="step" />
                    <div>
                        <h1 class="font-laonoto mt-4 text-center text-xl font-bold">ໂອນດ້ວຍເລກບັນຊີ</h1>
                        <p class="mt-2 text-center font-semibold text-gray-600">YOTHIN BOUBPHA</p>
                    ...
                    <button
                        class="mx-auto block rounded-md border bg-blue-500 px-6 py-2 text-white outline-none">ສົ່ງຫຼັກຖານການໂອນ</button>
                </div>
                <!-- Step Checkout -->
                <div class="mt-8 max-w-sm md:mt-0 md:ml-10 md:w-2/3">
                    ...
                    <div class="relative flex pb-12">
                        ...
                        <div class="flex-grow pl-4">
                            ...
                            <p class="font-laonoto leading-relaxed">ແຈ້ງຫຼັກຖານການຊຳລະເງິນດ້ວຍ <b>ຮູບໃບບິນ</b> ຫຼື
                                <b>ຮູບສະລິບການໂອນ</b>.
                            </p>
                        </div>
                    </div>
                    <div class="relative flex pb-12">
                        ...
                        <div class="flex-grow pl-4">
                            ...
                            <p class="font-laonoto leading-relaxed">
                                ສຳເລັດການໂອນ ກະລຸນາລໍຖ້າພະນັກງານກວດສອບ ທ່ານສາມາດກວດສອບສະຖານະການຊຳລະສຳເລັດໄດ້ ໄປທີ່ໜ້າ
                                <span>
                                    <b>Payments</b></span>.
                            </p>
                        </div>
