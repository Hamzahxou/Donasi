                ...
                <div class="min-w-max inline-flex relative">
                    <a href="/" class="relative flex items-center gap-3">
                        ...
                        <div class="inline-flex text-xl font-semibold text-gray-900">
                            <span class="text-orange-500 fw-bold">Do</span>nline
                        </div>
                    </a>
                </div>
                    ...
                    <ul
                        ...
                        <li>
                            <a href="{{ route('beranda') }}"
                                class="{{ request()->routeIs('beranda') ? 'text-orange-500 hover:text-orange-700' : 'hover:text-orange-500' }} duration-300 font-medium ease-linear   py-3">
                                Beranda
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('donation.index') }}"
                                class="{{ request()->routeIs('donation.*') ? 'text-orange-500 hover:text-orange-700' : 'hover:text-orange-500' }} duration-300 font-medium ease-linear   py-3">
                                Donasi
                            </a>
                        </li>
                        {{-- <li>
            ...
            <div class="grid grid-cols-1 gap-8 lg:grid-cols-3">
                <div>
                    ...
                    <p class="mt-4 max-w-xs text-gray-500">
                        Tuhan memberikan kita rezeki disetiap caranya, ia datang dari tempat atau seseorang yang tidak
                        kita duga
                    </p>
