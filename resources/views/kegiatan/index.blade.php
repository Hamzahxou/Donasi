<x-app-layout title="Kegiatan / Project">
    <x-slot name="header">
                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    <div>
                        <a href="{{ route('kegiatan.create') }}"
                            class="mb-2 inline-flex items-center px-4 py-2 bg-white border border-gray-300 rounded-md font-semibold text-xs text-gray-700 uppercase tracking-widest shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:ring-offset-2 disabled:opacity-25 transition ease-in-out duration-150">{{ __('Tambah') }}</a>
                    </div>
                    <form class="w-full">
                            ...
                            <tr>
                                ...
                                <td class="border px-6 py-4 hidden lg:table-cell">
                                    <div class="w-32 h-20 mx-auto">
                                        <img src="" class="w-full h-full md:w-32 max-w-full max-h-full"
                                ...
                                <td class="border px-6 py-4 text-center text-sm hidden lg:table-cell">
                                    <form action="" method="post">
                                        ...
                                        <select name="status" onchange="form.submit()"
                                            class="border border-gray-300 rounded-lg bg-gray-50 focus:ring-orange-500 focus:border-orange-500 loadingOther ">
                                            <option value="draft">
                                                Draft
                                            </option>
                                ...
                                <td class="border px-6 py-4">
                                    <div class="flex justify-center gap-2">
                                        ...
                                        <form action="" method="post" class="flex justify-center align-center">
                                            @csrf
                                            @method('DELETE')
