            ...
            <div class="bg-white shadow-sm sm:rounded-lg overflow-x-auto">
                <div class="p-6 bg-white border-b border-gray-200">
                    <div class="flex gap-2">
                        <form>
                            <select onchange="form.submit()" name="sampah"
                                class=" border border-gray-300 rounded-lg bg-gray-50 focus:ring-orange-500 focus:border-orange-500 ">
                                <option value="" disabled selected>Data data dihapus</option>
                                <option value="true" {{ request()->sampah == 'true' ? 'selected' : '' }}>
                                    Tampilkan</option>
                                <option value="false">
                                    Jangan Tampilkan</option>
                            </select>
                        </form>
                        <form class="w-full">
                                        ...
                                        @if (request()->sampah == 'true')
                                            ...
                                            <div x-show="approve[{{ $i }}]"
                                                ...
                                                <div x-data="{ image_{{ $i }}: false }"
                                                    ...
                                                    <form action="{{ route('pembayaran.restore', $donation->id) }}"
                                                        method="post">
                                                        @csrf
                                                        <div x-show="!image_{{ $i }}" class="my-2">
                                                            <x-input-label class="w-full"
                                                                for="konfirmasi_{{ $i }}">Kembalikan</x-input-label>
